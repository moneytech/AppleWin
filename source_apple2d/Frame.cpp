		...
		if (drawflags & DRAW_LEDS)
		{
			...
			if (!IS_APPLE2)
			{
				...
				switch (g_Apple2Type)
				{
					...
					case A2TYPE_APPLE2C: // intentional fall-through
					case A2TYPE_APPLE2D: // intentional fall-through
...
*/
		...
		if (drawflags & DRAW_TITLE)
		{
			...
			switch (g_Apple2Type)
			{
				default:
#if DEBUG
					MessageBox( GetDesktopWindow(), TEXT("Unknown Apple Type!"), TEXT("ERROR"), MB_OK );
					break;
#endif
				case A2TYPE_APPLE2:			_tcscpy(title, TITLE_APPLE_2); break; 
				case A2TYPE_APPLE2PLUS:		_tcscpy(title, TITLE_APPLE_2_PLUS); break; 
				case A2TYPE_APPLE2C:		_tcscpy(title, TITLE_APPLE_2C); break;
				case A2TYPE_APPLE2D:		_tcscpy(title, TITLE_APPLE_2D); break; 
