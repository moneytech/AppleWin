...
//		if( FAILED( g_pDDPrimarySurface->GetDC(&hDC) ) )
//		   return;
...
//		sText[0] = glyph;
//		sText[1] = 0;
//		TextOut( hDC, x, y, sText,2 );

//		g_pDDPrimarySurface->ReleaseDC(hDC);

		// pBackBuffer -> Blt( rect, FontSurface 
		//		g_pDDPrimarySurface->Blt( rect, surface, rect, word, );
